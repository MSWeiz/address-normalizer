        ...
        try: 
            if (pathlib.Path(ConsoleHelper.get_log_file_name()).is_file()): 
                if (save_log): 
                    ...
                    except Exception as ex3070: 
                        pass
                try: 
                    pathlib.Path(ConsoleHelper.get_log_file_name()).unlink()
                except Exception as ex3071: 
                    pass
