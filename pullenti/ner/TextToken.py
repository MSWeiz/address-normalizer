...
class TextToken(Token):
    ...
    def check_value(self, dict0_ : typing.List[tuple]) -> object:
        ...
        if (dict0_ is None): 
            return None
        res = None
        wrapres3003 = RefOutArgWrapper(None)
        inoutres3004 = Utils.tryGetValue(dict0_, self.term, wrapres3003)
        res = wrapres3003.value
        if (inoutres3004): 
            return res
            ...
            for it in self.morph.items: 
                ...
                if (mf is not None): 
                    if (mf.normal_case is not None): 
                        wrapres2999 = RefOutArgWrapper(None)
                        inoutres3000 = Utils.tryGetValue(dict0_, mf.normal_case, wrapres2999)
                        res = wrapres2999.value
                        if (inoutres3000): 
                            return res
                    if (mf.normal_full is not None and mf.normal_case != mf.normal_full): 
                        wrapres3001 = RefOutArgWrapper(None)
                        inoutres3002 = Utils.tryGetValue(dict0_, mf.normal_full, wrapres3001)
                        res = wrapres3001.value
                        if (inoutres3002): 
                            return res
        return None
    ...
    def get_normal_case_text(self, mc : 'MorphClass'=None, num : 'MorphNumber'=MorphNumber.UNDEFINED, gender : 'MorphGender'=MorphGender.UNDEFINED, keep_chars : bool=False) -> str:
        ...
        if (num == MorphNumber.SINGULAR and mc is not None): 
            bi = MorphBaseInfo._new831(MorphClass._new284(mc.value), gender, MorphNumber.SINGULAR, self.morph.language)
            vars0_ = None
            try: 
    ...
    @staticmethod
    def _new809(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.term0 = _arg5
        return res
    
    @staticmethod
    def _new812(_arg1 : 'MorphToken', _arg2 : 'AnalysisKit', _arg3 : int, _arg4 : int, _arg5 : 'CharsInfo', _arg6 : str) -> 'TextToken':
        res = TextToken(_arg1, _arg2, _arg3, _arg4)
        res.chars = _arg5
        res.term0 = _arg6
        return res