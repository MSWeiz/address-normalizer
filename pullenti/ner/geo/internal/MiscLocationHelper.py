...
class MiscLocationHelper:
    ...
    def get_geo_referent_by_name(name : str) -> 'GeoReferent':
        from pullenti.ner.geo.internal.TerrItemToken import TerrItemToken
        res = None
        wrapres1278 = RefOutArgWrapper(None)
        inoutres1279 = Utils.tryGetValue(MiscLocationHelper.__m_geo_ref_by_name, name, wrapres1278)
        res = wrapres1278.value
        if (inoutres1279): 
            return res
    ...
    def try_attach_nord_west(t : 'Token') -> 'MetaToken':
        ...
        if (tok is None): 
            return None
        res = MetaToken._new859(t, t, t.morph)
        t1 = None
