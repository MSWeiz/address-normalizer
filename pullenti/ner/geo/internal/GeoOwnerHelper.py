            ...
            if (lo.is_city): 
                ...
                if ("город;" in hit or "місто" in hit or "city" in hit): 
                    if ("поселение" in lot): 
                        ...
                        if (not "городско" in lot): 
                            ...
                            return False
                    if (((((("поселок" in lot or "селище" in lot or "хутор" in lot) or "станица" in lot or "село" in lot) or "деревня" in lot or "городок" in lot) or "местечко" in lot or "аул" in lot) or "улус" in lot or "пункт" in lot) or "слобода" in lot): 
                        return True
                if ("улус" in hit): 
                ...
                if ("поселение" in hit or "поселок" in hit or "улус" in hit): 
                    if ("деревня" in lot and "коттеджный поселок" in hit): 
                        return False
                    if ((((("село;" in lot or "деревня" in lot or "хутор" in lot) or "аул" in lot or "пункт" in lot) or "слобода" in lot or "станица" in lot) or "починок" in lot or "заимка" in lot) or "местечко" in lot): 
                        return True
                    if (lot == "поселение;"): 
                        if ("поселок" in hit): 
                            return False
