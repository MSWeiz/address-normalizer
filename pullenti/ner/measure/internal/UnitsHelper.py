...
class UnitsHelper:
    ...
    def initialize() -> None:
        ...
        uu = None
        t = None
        u = Unit._new1673("раз", "times", "раз", "times", MeasureKind.COUNT)
        UnitsHelper.UNITS.append(u)
        t = Termin._new123("РАЗ", u)
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("м", "m", "метр", "meter", MeasureKind.LENGTH)
        ...
        uu = Unit._new1673("миль", "mile", "морская миля", "mile", MeasureKind.LENGTH)
        uu.base_unit = u
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("фут", "ft", "фут", "foot", u, 0.304799472, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new123("ФУТ", uu)
        t.add_abridge("FT.")
        t.add_variant("FOOT", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("дюйм", "in", "дюйм", "inch", u, 0.0254, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new123("ДЮЙМ", uu)
        t.add_abridge("IN")
        t.add_variant("INCH", False)
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("ар", "are", "ар", "are", MeasureKind.AREA)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1673("га", "ga", "гектар", "hectare", MeasureKind.AREA)
        uu.base_unit = u
        ...
        t.add_abridge("GA")
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("г", "g", "грамм", "gram", MeasureKind.WEIGHT)
        ...
        uu = Unit._new1679("ц", "centner", "центнер", "centner", u, 100000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_abridge("Ц.")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("т", "t", "тонна", "tonne", u, 1000000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        ...
        u = Unit._new1673("л", "l", "литр", "liter", MeasureKind.VOLUME)
        ...
        uu = Unit._new1679("галлон", "gallon", "галлон", "gallon", u, 4.5461, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        ...
        t.add_abridge("ГАЛ")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("баррель", "bbls", "баррель нефти", "barrel", u, 158.987, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("сек", "sec", "секунда", "second", MeasureKind.TIME)
        UnitsHelper.USEC = u
        ...
        uu = Unit._new1673("мин", "min", "минута", "minute", MeasureKind.TIME)
        ...
        UnitsHelper.TERMINS.add(t)
        u = uu
        uu = Unit._new1679("ч", "h", "час", "hour", u, 60, MeasureKind.TIME)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("дн", "d", "день", "day", MeasureKind.TIME)
        UnitsHelper.UDAY = u
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("нед", "week", "неделя", "week", u, 7, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("мес", "mon", "месяц", "month", u, 30, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("квартал", "quarter", "квартал", "quarter", u, 91, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new123("КВАРТАЛ", uu)
        t.add_abridge("QUARTER")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("г", "year", "год", "year", u, 365, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1679("декада", "decade", "декада", "decade", u, 365 * 10, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UGRADUSC = Unit._new1673("°C", "°C", "градус Цельсия", "celsius degree", MeasureKind.TEMPERATURE)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UGRADUSF = Unit._new1673("°F", "°F", "градус Фаренгейта", "Fahrenheit degree", MeasureKind.TEMPERATURE)
        ...
        UnitsHelper.TERMINS.add(t)
        UnitsHelper.UPERCENT = Unit._new1673("%", "%", "процент", "percent", MeasureKind.PERCENT)
        ...
        uu = Unit._new1729("л.с.", "hp", "лошадиная сила", "horsepower", u, 735.49875)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1738("Ач", "Ah", "ампер-час", "ampere-hour", u, UnitsHelper.UHOUR)
        ...
        uu = Unit._new1729("бар", "bar", "бар", "bar", u, 100000)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new123("БАР", uu)
        t.add_variant("BAR", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1729("мм.рт.ст.", "mm Hg", "миллиметр ртутного столба", "millimeter of mercury", u, 133.332)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1729("кгс", "kgf", "килограмм-сила", "kilogram-force", u, 1000)
        UnitsHelper.UNITS.append(uu)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("IP", "IP", "IP", "IP", MeasureKind.IP)
        u.keywords.extend(["ЗАЩИТА", "КЛАСС ЗАЩИТЫ", "PROTECTION", "PROTACTION RATING"])
        UnitsHelper.UNITS.append(u)
        t = Termin._new123("IP", u)
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("кгU", "kgU", "килограмм урана", "kgU", MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(u)
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1673("кг", "kgZr", "килограмм циркония", "kgZr", MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(u)
    ...
    def __add_factor(f : 'UnitsFactors', u0 : 'Unit', abbr_cyr : str, abbr_lat : str, names_ru : str, names_ua : str, names_en : str) -> 'Unit':
        ...
        if (swichVal == UnitsFactors.CENTI): 
            ...
            pref_en = "TERA"
            mult = (1000000000000)
        u = Unit._new1777(pref_cyr.lower() + u0.name_cyr, pref_lat.lower() + u0.name_lat, pref_ru.lower() + u0.fullname_cyr, pref_en.lower() + u0.fullname_lat, f, mult, u0, u0.kind, u0.keywords)
