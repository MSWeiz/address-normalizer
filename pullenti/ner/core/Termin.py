...
class Termin:
    ...
    class Term:
        ...
        @staticmethod
        def _new2057(_arg1 : 'TextToken', _arg2 : bool) -> 'Term':
    ...
    class Abridge:
        ...
        def add_part(self, val : str, has_delim : bool=False) -> None:
            self.parts.append(Termin.AbridgePart._new920(val, has_delim))
        ...
        def try_attach(self, t0 : 'Token') -> 'TerminToken':
            ...
            if (self.tail is None): 
                ...
                while i < len(self.parts): 
                    ...
                    tt = tt.next0_
                    i += 1
                res = TerminToken._new921(t0, te, t0 == te)
                if (point): 
    ...
    class AbridgePart:
        ...
        @staticmethod
        def _new920(_arg1 : str, _arg2 : bool) -> 'AbridgePart':
        ...
        @staticmethod
        def _new922(_arg1 : str) -> 'AbridgePart':
            res = Termin.AbridgePart()
            res.value = _arg1
            return res
    ...
    def add_abridge(self, abr : str) -> 'Abridge':
        ...
        if (i == 0): 
            return None
        a.parts.append(Termin.AbridgePart._new922(abr[0:0+i].upper()))
                ...
                if (str.isalpha(abr[i])): 
                    ...
                    while j < len(abr): 
                        if (not str.isalpha(abr[j])): 
                            break
                        j += 1
                    p = Termin.AbridgePart._new922(abr[i:i+j - i].upper())
                    if (j < len(abr)): 
        ...
        if (self.acronym_smart is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO) and term is not None): 
            if (self.acronym_smart == term or self.acronym_smart == term0): 
                if (t0.next0_ is not None and t0.next0_.is_char('.') and not t0.is_whitespace_after): 
                    return TerminToken._new748(t0, t0.next0_, self)
                else: 
                    return TerminToken._new748(t0, t0, self)
            i = 0
            t1 = Utils.asObjectOrNull(t0, TextToken)
            ...
            if (i >= len(self.acronym)): 
                return TerminToken._new748(t0, t1, self)
            ...
            if (ok and i >= len(self.terms)): 
                ...
                if (t0 != t1 and t0.morph.class0_.is_adjective): 
                    ...
                    if (npt is not None and npt.end_char <= t1.end_char): 
                        mc = npt.morph
                return TerminToken._new929(t0, t1, mc)
    ...
    def try_parse_sim(self, t0 : 'Token', simd : float, pars : 'TerminParseAttr'=TerminParseAttr.NO) -> 'TerminToken':
        ...
        if (len(self.terms) > 0): 
            ...
            return TerminToken._new935(t0, t1, mc, self)
        if (self.abridges is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO)): 
            res = None
            for a in self.abridges: 
                r = a.try_attach(t0)
    ...
    @staticmethod
    def _new333(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new344(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
    ...
    @staticmethod
    def _new345(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
    ...
    @staticmethod
    def _new347(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new354(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new359(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new361(_arg1 : str, _arg2 : object, _arg3 : str) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        return res
    ...
    @staticmethod
    def _new363(_arg1 : str, _arg2 : object, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
    ...
    @staticmethod
    def _new406(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : str, _arg5 : bool, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new570(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        return res
    ...
    @staticmethod
    def _new571(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new573(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new574(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new613(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new614(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new617(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphLang', _arg5 : object, _arg6 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.lang = _arg4
    ...
    @staticmethod
    def _new618(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new622(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new664(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.lang = _arg4
    ...
    @staticmethod
    def _new726(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        return res
    
    @staticmethod
    def _new757(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object) -> 'Termin':
    ...
    @staticmethod
    def _new886(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag = _arg4
        return res
    
    @staticmethod
    def _new1040(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        return res
    
    @staticmethod
    def _new1210(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        return res
    
    @staticmethod
    def _new1262(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.canonic_text = _arg3
        return res
    
    @staticmethod
    def _new1265(_arg1 : str, _arg2 : str, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        return res
    ...
    @staticmethod
    def _new1276(_arg1 : str, _arg2 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.ignore_terms_order = _arg2
        return res
    
    @staticmethod
    def _new1299(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        return res
    
    @staticmethod
    def _new1320(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
    ...
    @staticmethod
    def _new1322(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new1367(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag3 = _arg2
        return res
    
    @staticmethod
    def _new1392(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1393(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1395(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1435(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1447(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1458(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.acronym_can_be_smart = _arg4
    ...
    @staticmethod
    def _new1467(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender', _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1482(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1486(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_smart = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1494(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1495(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1497(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1498(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1568(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        return res
    
    @staticmethod
    def _new1569(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin()
        res.acronym = _arg1
        res.lang = _arg2
        return res
    ...
    @staticmethod
    def _new2461(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        return res
    
    @staticmethod
    def _new2780(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag2 = _arg4
        return res
    
    @staticmethod
    def _new2856(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new2866(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new2879(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        res.tag = _arg5
        res.tag2 = _arg6
    ...
    @staticmethod
    def _new2883(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
    ...
    @staticmethod
    def _new2895(_arg1 : str, _arg2 : object, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.ignore_terms_order = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new2933(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
