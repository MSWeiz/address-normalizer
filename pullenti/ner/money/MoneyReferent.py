...
class MoneyReferent(Referent):
    ...
    def value(self) -> float:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1795 = RefOutArgWrapper(0)
        inoutres1796 = Utils.tryParseFloat(val, wrapv1795)
        v = wrapv1795.value
        if (not inoutres1796): 
            return 0
        return v
    ...
    def alt_value(self) -> float:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1797 = RefOutArgWrapper(0)
        inoutres1798 = Utils.tryParseFloat(val, wrapv1797)
        v = wrapv1797.value
        if (not inoutres1798): 
            return None
        return v
    ...
    def rest(self) -> int:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1799 = RefOutArgWrapper(0)
        inoutres1800 = Utils.tryParseInt(val, wrapv1799)
        v = wrapv1799.value
        if (not inoutres1800): 
            return 0
        return v
    ...
    def alt_rest(self) -> int:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1801 = RefOutArgWrapper(0)
        inoutres1802 = Utils.tryParseInt(val, wrapv1801)
        v = wrapv1801.value
        if (not inoutres1802): 
            return None
        return v
