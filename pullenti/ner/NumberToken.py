...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn2976 = RefOutArgWrapper(0)
        inoutres2977 = Utils.tryParseInt(self.__m_value, wrapn2976)
        n = wrapn2976.value
        if (inoutres2977): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new851(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
